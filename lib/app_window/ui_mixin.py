...
class UIMixin:
    ...
    def setup_ui(self):
        ...
        self.blame_file_btn = QPushButton("Blame File")
        ...
        self.multiselect_menu_btn = QPushButton("Perform action on selected commits")
        self.multiselect_menu_btn.setToolTip("Choose an action to apply to the selected commits.")
        self.multiselect_menu_menu = QMenu(self)
        ...
        self.multiselect_menu_menu.addAction(self.squash_selected_action)
        self.multiselect_menu_menu.addAction(self.mark_selected_action)
        self.multiselect_menu_menu.addAction(self.drop_selected_action)
        self.multiselect_menu_menu.addAction(self.move_selected_action)
        self.multiselect_menu_menu.addSeparator()
        ...
        self.multiselect_menu_menu.addMenu(self.create_patch_menu)
        self.multiselect_menu_menu.addSeparator()
        ...
        self.multiselect_menu_menu.addAction(self.difftool_selected_action)
        ...
        self.multiselect_menu_menu.addAction(self.copy_shas_selected_action)
        self.multiselect_menu_btn.setMenu(self.multiselect_menu_menu)
        ...
        for btn in [self.multi_select_btn, self.multiselect_menu_btn, self.cancel_multi_btn]:
            btn.setMinimumHeight(40)
        ...
        squash_layout.addWidget(self.multiselect_menu_btn)
